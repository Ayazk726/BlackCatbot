...
if __name__ == '__main__':
    spider = Spider()
    spider.download_icon_unit(start=1001, end=1250, star=3)
    spider.download_icon_unit(start=1001, end=1250, star=6)
    spider.download_comic(start=1, end=225, only_index=False)
